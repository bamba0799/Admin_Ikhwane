...
import { UpdateCoFormValues } from '../../../services/model';
...
const UpdateCo = () => {
    ...
    const { register, handleSubmit, setValue, formState, control } = useForm<UpdateCoFormValues>({
        defaultValues: {
            nomPers: "",
            pernomPers: "",
            genrePers: "",
    ...
    const updateCo = async (data: any) => {
        ...
        try {
            ...
            const { data: seminariste } = await apiService.updateCo(coId!, datas);
    ...
    const getCoById = async () => {
        try {
            const { data: pco } = await apiService.getCoById(coId!);
            console.log("ccccccccc", pco[0]);
                ...
                <SecondLayout title={"Comité d'organisation"}>
                    <div className="flex justify-between">
                        <div className="w-full flex flex-row justify-between">
                            <h1 className="text-2xl font-semibold text-primary_green">Modifier Co</h1>
                    ...
                    <div className="mt-4 border px-[10px] md:px-[40px] shadow-2xl rounded-[10px]">
                        ...
                        <form onSubmit={handleSubmit(updateCo)} className='flex flex-col space-y-[20px] md:space-y-[50px] py-[10px] md:py-[30px]'>
                            {/* line 1 */}
