...
const apiService = {
    ...
    getTotalByComiMateriel: async () => getData("/materiel/getTotalByComi"),
    ...
    //document
    getBadgeSeminaristeData: async (data: any) => postData("/personne/badge", data),
/*         getBadgeSemiData: async (seminaristeId: any) => getDataById(`/seminariste/getone`, seminaristeId),
 */};
